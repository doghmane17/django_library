# Generated by Django 4.2.24 on 2025-11-14 23:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='cataloge.book')),
        ...
        migrations.AddField(
            model_name='book',
            name='gener',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='cataloge.gener'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cataloge.language'),
        ),
    ]
